...
void MPU6050::update(){
  ...
  rawwAccX = wire->read() << 8 | wire->read();
  rawwAccY = wire->read() << 8 | wire->read();
  rawwAccZ = wire->read() << 8 | wire->read();
  rawTemp = wire->read() << 8 | wire->read();
  rawwGyroX = wire->read() << 8 | wire->read();
  rawwGyroY = wire->read() << 8 | wire->read();
  rawwGyroZ = wire->read() << 8 | wire->read();
